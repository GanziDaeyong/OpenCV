...
face_cascade_name = r'C:\Users\iwin1\Envs\opencv_practice\Lib\site-packages\cv2\data\haarcascade_frontalface_alt.xml'
eyes_cascade_name = r'C:\Users\iwin1\Envs\opencv_practice\Lib\site-packages\cv2\data\haarcascade_eye_tree_eyeglasses.xml'
file_name = r'C:\대용\컴퓨터공부\과외학원인강\openCV\opencv_dnn_202005\image\marathon_01.jpg'
title_name = 'Haar cascade object detection'
frame_width = 500

def selectFile():
    dir = r'C:\대용\컴퓨터공부\과외학원인강\openCV\opencv_dnn_202005\image'
...
read_image = cv2.imread(r'C:\대용\컴퓨터공부\과외학원인강\openCV\opencv_dnn_202005\image\marathon_01.jpg')
(height, width) = read_image.shape[:2]
